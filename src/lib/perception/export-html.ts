...
export function buildStandaloneHtml(payload: ExportPayload): string {
...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  #artwork { max-width: 88vmin; max-height: 88vmin; display: block; user-select: none; pointer-events: none; }
...
export function downloadJson(filename: string, payload: ExportPayload): void {
